...
class Player{
    constructor(){
        ...
        // ---------------------------A------------------------------
        this.radio_name = ['stif FM', 'Algeria FM','Algeria 4','Algeri']
        this.radio_source = ['https://setif.ice.infomaniak.ch/19.aac','https://adrar.ice.infomaniak.ch/01.aac','https://adrar.ice.infomaniak.ch/01.aac','https://setif.ice.infomaniak.ch/19.aac'];
